...
const NOVEL = {
  ...
  episodes: [
    ...
    },
    {
      ...
      cover: "ep2.png",
      content: `레오는 창밖을 올려다보았다. 하얀 태양이 중앙에 떠 있었다. 정오였다. 아래로는 자동차들이 일정한 간격으로 움직이고 있었다. 소음은 닿지 않았고, 형태만 남아 있었다. 장난감처럼 보였다. 그 크기로 보아, 이곳은 충분히 높았다.\n\n등 뒤에서 인간의 목소리가 들렸다. 의미는 알 수 없었지만, 방향은 분명했다. 표정과 손짓이 불만을 가리키고 있었다. 레오는 그 불만이 자신을 향하고 있다는 사실만 이해했다. 무언가가 일어날 것이라는 예감은 있었지만, 대비할 시간은 없었다.\n\n인간의 손이 내려와 레오의 뒷덜미를 잡았다. 다음 순간, 시야가 급격히 낮아졌고 공간이 좁아졌다. 캔넬이었다. 그는 몸을 비틀었다. 발을 뻗고, 이를 드러냈다. 하지만 움직임은 끝까지 전달되지 않았다. 허공을 긁는 감각만 남았다. 물속에서 발버둥치는 것과 비슷했다. 저항은 있었지만, 닿는 것은 없었다.\n\n어릴 적의 감각이 몸에 먼저 반응했다. 캔넬 안에서 보냈던 시간. 그때의 냄새와 흔들림이 겹쳐졌다. 이유를 따질 틈은 없었다. 몸은 이미 불길함을 알고 있었다.\n\n캔넬이 다시 열렸을 때, 장소는 바뀌어 있었다. 흰 벽. 소독약 냄새. 하얀 가운을 입은 인간들이 레오를 내려다보고 있었다. 그들은 서로 말을 주고받았다. 레오가 알아들을 수 없는 소리였다. 그러나 그 대화에 자신이 포함되어 있다는 사실만은 분명했다.\n\n주사가 들어왔다. 몸이 무거워졌다. 이어서 수술이 시작됐다. 동의는 묻지 않았다. 레오의 의사는 필요하지 않았다. 이 과정에서 중요한 것은, 그가 무엇을 원하는지가 아니었다.\n\n레오는 자신의 몸을 바라보고 있었다. 메스가 닿았고, 피부가 갈라졌다. 찌르는 동작이 반복됐다. 이상하게도 통증은 선명하지 않았다. 감각은 멀어지고, 시야는 위에서 아래를 내려다보는 형태로 고정됐다. 그는 움직이지 않았고, 움직일 수 없었다.\n\n그때 소리가 들렸다. 작았다. 하지만 분명했다. 다른 소리들 사이에서 유독 또렷했다. 어디선가 들려온 목소리였다. 익숙했다.\n\n“아빠…”\n\n그 뒤의 말은 이어지지 않았다. 이어졌을지도 모른다. 하지만 레오에게 도달하지는 않았다. 소리는 중간에서 끊겼고, 의미는 남지 않았다. 기억 속에서 지워진 부분처럼, 빈 자리만 남았다.\n\n눈을 뜨자 태화강이 보였다. 물 위로 빛이 반사되고 있었다. 레오는 한동안 움직이지 않았다. 방금까지의 장면이 사라졌다는 사실을 받아들이는 데 시간이 필요했다. 꿈이었다. 불쾌한 꿈이었다. 과거의 어떤 기억과 맞닿아 있다는 점만은 분명했지만, 구체적인 형태는 떠오르지 않았다.\n\n목에 걸린 방울이 느껴졌다. 평소보다 무거웠다. 실제 무게 때문인지, 아니면 다른 이유 때문인지는 알 수 없었다. 레오는 고개를 숙였다. 방울이 흔들리며 소리를 냈다.\n\n그 소리는, 여전히 자신이 여기 있다는 사실을 증명하고 있었다.\n\n어딘가 비어 있는 감각이 레오에게 남아 있었다. 무엇인가 빠져 있다는 느낌이었다. 하지만 그 대상은 떠오르지 않았다. 떠오르지 않는다는 점에서, 중요하지 않은 일일 가능성이 높다고 그는 판단했다. 기억나지 않는 것은 대개 생존에 큰 영향을 주지 않는다.\n\n레오는 그 공백을 배고픔으로 정리했다. 그러자 계산은 자연스럽게 맞아떨어졌다. 판단이 흐릿해진 이유도, 생각이 같은 자리를 맴도는 이유도 설명이 됐다. 고양이는 배가 비면 정확한 선택을 하지 못한다. 그 사실은 주변 고양이들을 통해 반복해서 확인된 공식이었다. 인간을 경계한다고 말하던 고양이들조차, 허기 앞에서는 고개를 숙였다.\n\n며칠째 제대로 된 먹이를 얻지 못하고 있었다. 예전에는 다가가기만 해도 무언가를 내밀던 인간들이, 이제는 시선을 피했다. 레오는 자신의 모습이 달라졌다는 사실을 알고 있었다. 관리에서 벗어난 직후까지는 털이 정돈돼 있었고, 움직임도 느긋했다. 인간들은 그것을 귀엽다고 불렀다. 그 호칭 덕분에 몇 달간은 굶지 않을 수 있었다.\n\n하지만 상황은 바뀌었다. 더 깨끗하고, 더 어린 고양이들이 그 자리를 차지했다. 인간의 관심은 늘 한정돼 있다. 나뉘지 않는다. 대체될 뿐이다. 레오에게 돌아올 몫은 없었다.\n\n한 번은 쓰레기통을 확인하다가 인간에게 들켰다. 목에 걸린 방울이 소리를 냈다는 사실을 나중에야 떠올렸다. 인간의 발이 날아왔다. 레오는 그 장면을 계산하지 못했다. 고양이는 원래 민첩하다. 대비만 되어 있었다면 피할 수 있었을 것이다. 하지만 레오는 대비하지 않았다. 인간에게 차이는 장면은 그의 머릿속에 준비되어 있지 않았다. 그래서 그는 그대로 밀려났다. 바닥을 굴렀고, 잠시 숨이 막혔다.\n\n물론 발길질을 예상했더라도, 결과는 달라지지 않았을 가능성이 높았다. 레오는 다른 고양이들과 달랐다. 태어날 때부터 느렸다. 보호소에서 태어났고, 태어난 날 어미를 잃었다. 기억은 없었다. 다만 그곳에 자신만 남았다는 결과만이 있었다. 행동도, 결정도 고양이답지 않다는 말을 들었다. 인간에게 쉽게 다가갔고, 손길을 피하지 않았다. 느린 성향은 길 위에서는 단점이었고, 실내에서는 장점이었다.\n\n그의 주인이 보호소에서 레오를 데려간 이유도 그 때문이었다. 선택은 빠르게 이루어졌고, 검토는 필요 없었다. 느긋한 고양이는 관리하기 쉽다. 레오는 그 기준에 정확히 부합했다.\n\n인간의 집에는 이미 다른 고양이가 있었다. 또래로 보이는 암컷이었다. 어린 나이였지만, 움직임에는 묘한 안정감이 있었다. 레오는 그 점을 먼저 알아차렸다. 인간들이 붙여준 이름은 기억하지 않았다. 중요하지 않았기 때문이다. 그는 그녀를 이름으로 부르지 않았다. 대신, 그 자리에 함께 있다는 사실만을 인식했다.\n\n그것으로 충분했다.\n\n그때의 레오에게는, 그것이 전부였다.\n\n지금의 레오는 혼자였다. 과거의 기억은 길 위에서 지워진 지 오래였다. 언제부터였는지는 중요하지 않았다. 밖에서 살기 시작한 뒤, 기억은 하나씩 희미해졌고, 결국 남은 것은 몇 개의 감각뿐이었다. 그녀에 대해서도 마찬가지였다. 첫 만남의 장면을 떠올릴 수는 없었다. 다만, 이유를 설명할 수 없는 감정이 마음속에 남아 있다는 사실만이 분명했다.\n\n레오는 기지개를 켜며 몸을 일으켰다. 가능한 한 빨리 움직이려 했다. 방금 꾼 꿈을 잊기 위해서였다. 그는 기억력이 좋은 고양이는 아니었지만, 악몽이 스쳐간 자리에 오래 머무르고 싶지는 않았다. 이곳을 떠나면, 그 감각도 함께 흐려질 것이라 판단했다.\n\n몸은 즉각 반응했다. 일어서자마자 배속에서 신호가 올라왔다. 허기였다. 요동치는 감각이 판단보다 먼저 도착했다. 레오는 고개를 숙였다. 지금 필요한 것은 생각이 아니라, 먹을 것이었다.`
    }
  ]
};
