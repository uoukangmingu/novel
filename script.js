...
const NOVEL = {
  ...
  episodes: [
    ...
    },
    {
      id: "ep1",
      title: "Ep1 - 미야",
      date: "작성일자 2026-01-13",
      cover: "ep1.png",
      content: `야오는 그렇게 세상에 나왔다.\n\n미야는 처음 그 모습을 보았을 때, 물에 빠진 쥐새끼를 떠올렸다. 실제로 그런 장면을 본 적은 없었다. 다만 그렇게 생겼을 것이라 짐작했을 뿐이다. 야오는 작았고, 지나치게 여렸다. 미야의 파란 눈을 닮은 검은 털 아래로 검붉은 액체가 엉겨 붙어 있었다. 탯줄은 아직 끊어지지 않은 채 배에 매달려 있었다.\n\n미야는 조심스럽게 혀를 내밀었다. 피와 체액을 핥아내는 동안 불쾌함은 들지 않았다. 평소라면 경계했을 냄새였지만, 지금은 그렇지 않았다. 야오의 몸은 점점 마르며 형태를 갖췄다. 마지막으로 탯줄을 이로 끊었을 때, 미야는 그제야 숨을 고를 수 있었다.\n\n계절은 여름에서 가을로 넘어가고 있었다. 낙엽이 산책로를 따라 흩어져 있었다. 미야가 자리를 잡은 곳은 태화강이 내려다보이는 공원의 돌계단 아래였다. 계단을 오르내리는 인간은 많았지만, 그 바로 아래를 들여다보는 경우는 드물었다. 바쁘게 움직이는 존재는 발밑의 빈 공간에 관심을 두지 않는다. 인간이 자주 드나든다는 점은 다른 포식자에게도 부담이 되었다. 미야가 이곳을 택한 이유였다.\n\n야오가 미세하게 움직였다. 미야는 즉시 시선을 내렸다. 작은 몸이 규칙 없이 뒤척이고 있었다. 미야에게도 처음 겪는 일이었다. 본능은 하나의 결론을 내렸다. 배 속에서 유지되던 온기가 사라진 이곳은, 야오에게 차가울 것이다.\n\n“야오.”\n\n소리는 낮고 짧았다. 미야는 몸을 돌려 낙엽을 긁어모았다. 엉덩이와 앞발을 써서 돌계단 사이로 밀어 넣었다. 한 번으로는 부족했다. 같은 동작을 몇 차례 반복한 뒤에야 틈은 채워졌다. 입구에는 낙엽을 더 쌓아 바람을 막았다. 구조는 단순했고, 효과는 제한적이었다.\n\n“이제 괜찮아.”\n\n야오의 떨림은 멈추지 않았다. 오히려 더 잦아졌다. 미야는 긴장을 풀 수 없었다. 출산은 이번이 처음이 아니었다. 이미 세 마리를 낳았고, 모두 오래 머물지 못했다. 이유는 알 수 없었다. 체념에 가까운 상태로 맞이한 네 번째가 야오였다.\n\n임신 기간 동안 미야는 충분히 먹지 못했다. 출산 전날까지도 임신 사실을 인식하지 못했다. 배 속에서 자라던 네 개의 생명은 각자 다른 시점에서 한계를 맞았을 가능성이 컸다. 미야는 그 사실을 논리로 정리하지 않았다. 다만 결과만 알고 있었다.\n\n야오는 다시 몸을 움직였다. 방향은 일정했다. 미야 쪽이었다. 걸을 수 없는 몸이 선택할 수 있는 이동 방식은 하나뿐이었다. 몸을 끌며 조금씩 거리를 줄였다. 입이 미세하게 열리고 닫혔다. 공기를 찾는 것처럼, 혹은 무엇인가를 더듬는 것처럼 보였다. 결국 야오는 미야의 배에 닿았다. 계산된 행동이라기보다는, 반복된 반사에 가까운 움직임이었다.\n\n미야는 그 모습을 내려다보았다. 젖을 찾는 행동이라는 것을 알아보는 데 오래 걸리지 않았다. 그녀는 움직이지 않았다. 도와주지도, 밀어주지도 않았다. 야오가 스스로 닿기를 기다렸다. 한참이 지나서야 야오는 젖을 물었다.\n\n그 이후의 동작도 느렸다. 앞발이 번갈아 움직였고, 힘은 일정하지 않았다. 빨라지지 않았다. 미야는 시선을 떼지 못했다. 갓 태어난 새끼가 느린 것은 당연했다. 머리로는 그렇게 정리할 수 있었다. 하지만 눈앞의 움직임은 그 당연함을 넘어서 있었다. 하나하나가 지나치게 신중했고, 시간은 과하게 소모되고 있었다.\n\n젖을 다 먹는 데에는 오래 걸렸다. 미야는 시간을 세지 않았다. 다만, 한 번의 포만으로 끝날 시간이 아니라는 것만은 분명했다. 결국 야오는 젖에서 떨어졌다. 다 먹어서였는지, 미야가 먼저 몸을 옮겼기 때문인지는 알 수 없었다. 결과만 남았다. 파란 눈의 검은 몸이 눈도 뜨지 못한 채 바닥에 누워 있었다. 배는 부풀어 있었고, 호흡은 안정돼 보였다. 떨림은 잦아들었다.\n\n그럼에도 미야는 시선을 거두지 않았다. 배가 찬 상태와 살아남는 상태는 같지 않다는 것을 알고 있었기 때문이다. 이 느린 생명이 앞으로 맞닥뜨릴 시간들은 이미 충분히 계산되어 있었다. 계절은 곧 바뀔 것이고, 냄새는 줄어들 것이다. 그때 필요한 것은 충분함이 아니라 속도였다.\n\n미야가 낙엽 몇 장을 끌어와 야오의 몸 위에 덮으려던 순간, 바깥에서 소리가 났다. 규칙 없는 발걸음. 바닥을 끄는 소리. 오래된 음식물과 금속, 인간의 손이 남긴 냄새. 미야는 그 조합을 알고 있었다.\n\n“이건 또 뭐야. 입구를 다 막아놨네.”\n\n낮고 걸걸한 목소리였다. 낙엽을 건드리는 소리가 났다. 야오는 깨지 않았다. 미야는 그 점을 먼저 확인했다. 그 다음에야 입구 쪽을 보았다.\n\n레오임이 틀림없어 보였다.\n\n인간에게 길러지다 버려진 고양이. 그 사실은 그의 걸음걸이와 냄새에 남아 있었다. 사냥의 리듬이 없었고, 쓰레기통을 뒤진 흔적이 몸에 배어 있었다. 그는 늘 같은 방식으로 나타났다. 예고 없이, 그리고 너무 가까이까지.\n\n“미야! 안에 있지?”\n\n미야는 잠시 대답하지 않았다. 모른 척하면 돌아갈 수도 있었다. 하지만 그럴 경우 레오는 더 가까이 들어올 것이다. 낙엽을 헤치고, 틈을 넓히고, 결국 안쪽을 들여다볼 것이다. 그 선택지는 배제해야 했다.\n\n“왜 왔어.”\n\n소리는 낮췄다. 짜증을 숨기지도 않았다.\n\n“대답 없으면 혼자 있고 싶은 거라고 생각하고 가야지.”\n\n바깥에서 짧은 웃음소리가 났다. 낙엽 사이로 몸이 움직이는 기척이 전해졌다. 곧 헛기침 같은 소리가 뒤따랐다.\n\n“불렀는데 대답이 없으니까. 걱정돼서. 피 냄새도 나는 것 같고.”\n\n미야는 즉시 낙엽 쪽으로 시선을 돌렸다. 말보다 먼저 반응한 것은 몸이었다. 출산의 흔적은 아직 남아 있었다. 그녀는 그것을 누구에게도 보여줄 생각이 없었다. 설명할 생각도 없었다.\n\n미야는 몸을 조금 앞으로 옮겼다. 낙엽과 자신의 몸으로 안쪽을 가렸다. 그 동작에 의도가 담겼다는 것을, 그녀 자신도 알고 있었다. 지금 이곳에는 드러내지 말아야 할 것이 있었다.\n\n“피 냄새 같은 소리 하고 있네. 쓰레기통을 하도 뒤져서 코가 망가진 거 아냐?”\n\n“그런가? 뭐, 그럴 수도 있겠네. 얼마 전에 곰팡이 핀 식빵을 먹은 뒤로 좀 이상하긴 했어.”\n\n미야는 그 말에 대답하지 않았다. 그것 때문이 아니라, 원래부터 이상했다는 생각이 떠올랐지만 입 밖으로 내지 않았다. 자신이 이 고양이를 경계하고 있다는 사실이 오히려 낯설었다. 레오는 원래 이런 관심을 보일 존재가 아니었다. 고양이 회의에서 몇 번 얼굴을 본 정도였다.\n\n“그래서,” 미야가 말했다. “진짜 왜 왔어.”\n\n낙엽이 레오의 앞발에 툭툭 건드려졌다. 부수려는 의도는 없어 보였다. 단순한 확인에 가까운 동작이었다.\n\n“여기 내가 두고 간 게 있어서. 그거 좀 찾으러.”\n\n미야는 안쪽을 한 번 더 가렸다. 경계는 늦추지 않은 채였다.\n\n“내 집에? 여기 들어왔었어?”\n\n“…어.”\n\n망설임은 죄책감이라기보다는, 질문을 이해하지 못한 쪽에 가까웠다. 레오에게 침입은 개념이 아니라 이동의 결과였다.\n\n“누구 마음대로 남의 영역에 들어와!”\n\n미야의 하악질은 짧았고, 공기를 찢지 않았다. 그만큼 가까운 거리였다.\n\n“영역? 난 그런 거 잘 몰라.” 레오는 어리숙한 소리로 답했다.\n\n“왔을 때 여기가 비어 있었어. 그땐 네가 사는지도 몰랐고.”\n\n그의 말에는 변명이 섞이지 않았다. 설명도 아니었다. 레오의 생활은 오래전에 인간의 리듬에 맞춰졌고, 그 리듬에는 경계가 없었다. 길 위에서는 공간을 존중하지 않으면 오래 버티지 못한다. 하지만 인간에게 길러진 고양이에게 공간은 소유가 아니라 공백에 가까웠다. 레오는 늘 즉흥적으로 잠자리를 찾았고, 머문 흔적을 남기지 않았다.\n\n미야는 그 사실을 이해했지만, 받아들이지는 않았다. 누군가 자신의 안쪽에 발을 들였다는 판단은, 곧바로 위험으로 이어졌다.\n\n“뭘 두고 갔는데. 그것만 주면 끝나?”\n\n“응. 그것만.”\n\n레오의 목소리가 한 박자 가벼워졌다.\n\n미야는 입구에 쌓아둔 낙엽을 조금 치웠다. 틈이 보이자마자 레오는 얼굴을 밀어 넣었다. 미야는 즉시 앞발로 그의 얼굴을 밀어냈다. 자신의 머리로 틈을 다시 막았다.\n\n“미안. 내가 좀 급해.”\n\n“찾는 게 뭔지나 말해.”\n\n“내… 방울.”\n\n미야는 그제야 알아차렸다. 레오의 목에 늘 달려 있던 것이 보이지 않았다. 고양이 회의에서 보았을 때는 분명 있었다. 그가 이곳에 나타났을 때, 방울 소리가 들리지 않았다는 사실도 이제야 떠올랐다. 어느 순간 레오는 미야가 자리를 비운 사이, 자신의 방울을 이 안쪽에 숨겨두고 떠난 것이다.\n\n“어디다 뒀는데?”\n\n“안쪽. 땅 좀 파면 바로 나올 거야. 내 냄새가 진할 테니까. 못 찾으면 내가 들어가도 되고.”\n\n“그럴 생각은 하지 마.”\n\n미야는 말을 끊었다. “잠깐 기다려.”\n\n안쪽으로 들어가자 바람이 미세하게 스쳤다. 미야는 먼저 야오를 확인했다. 낙엽은 그대로였고, 몸은 잘 덮여 있었다. 그제야 바닥에 코를 대고 냄새를 더듬었다. 하지만 냄새는 쉽게 나타나지 않았다. 출산 이후, 감각은 아직 제 기능을 찾지 못하고 있었다. 자신의 피 냄새가 안쪽을 채우고 있었다. 레오의 흔적을 놓친 것도 그 때문이었을 것이다.\n\n잠시 뒤, 다른 냄새가 걸렸다. 구석진 지점이었다. 미야는 앞발로 흙을 파냈다. 작은 금속이 드러났다. 방울이었다. 인간의 글자가 새겨져 있었지만, 읽을 필요는 없었다. 냄새가 분명했다. 레오의 것이었다. 그제야 바람이 잦아들었다.\n\n방울을 입에 문 채 입구로 돌아왔을 때, 레오는 다시 틈으로 고개를 들이밀고 있었다. 시선은 안쪽을 향해 있었다. 미야는 급히 다가가 그의 머리를 밀어냈다. 방울을 바닥에 떨어뜨렸다.\n\n“이거. 네가 찾던 거.”\n\n레오는 방울을 보고 숨을 내쉬었다.\n\n“다행이다. 이게 없으면 좀 불안해서.”\n\n미야가 다시 낙엽을 쌓으려 하자, 레오가 서둘러 말했다.\n\n“미야. 너 출산했구나. 애가 너랑 닮았어.”\n\n말은 가볍게 나왔지만, 미야의 몸은 굳었다. 레오라는 변수는 예측이 어려웠다. 그의 말이 어디까지 흘러갈지도 알 수 없었다.\n\n“내가 애를 낳았다는 말.” 미야는 낮게 말했다.\n\n“아직 아무한테도 하지 마. 애가 스스로 움직일 수 있을 때쯤이면, 그땐 알아서 알게 될 거야.”\n\n레오는 고개를 끄덕였다.\n\n“출산 뒤엔 보통 힘이 없던데. 넌 괜찮아 보이네. 역시 길에서 산 애들은 좀 다른가.”\n\n그 말에 미야는 이유를 알 수 없는 불쾌함을 느꼈다. 길에서 태어났다는 사실을 숨긴 적은 없었다. 그런데도 그 말은 경계를 긁었다. 레오의 얼굴은 다시 입구 쪽으로 가까워져 있었다.\n\n“처음 낳아본 거지? 애가 저렇게 배가 찼을 땐, 엉덩이 쪽을 핥아줘야 해. 그래야 볼일을 보거든.”\n\n미야는 그 말을 처음 들었다. 몰랐다는 사실이 먼저 떠올랐다. 그 다음에야, 레오가 그런 지식을 갖고 있다는 점이 의아해졌다. 표현은 서툴렀지만, 의도는 단순해 보였다.\n\n“그걸 어떻게 알아?”\n\n“나도 애가 있었거든.”\n\n레오는 말을 흐렸다. “지금은 이런 꼴이지만.”\n\n그는 방울을 입에 물고 몸을 돌렸다.\n\n“난 간다.”\n\n레오가 떠났다. 생각보다 조용했다. 아무 일도 일어나지 않았다는 판단은, 그가 시야에서 완전히 사라진 뒤에야 가능했다. 미야는 낙엽을 다시 정리했다. 틈을 막고, 안쪽을 확인했다.`
    },
    {
      id: "ep2",
      title: "Ep2 - 레오",
      date: "작성일자 2026-01-22",
      cover: "ep2.png",
      content: `레오는 창밖을 올려다보았다.\n\n하얀 태양이 중앙에 떠 있었다. 아래로는 자동차들이 일정한 간격으로 움직이고 있었다. 소음은 닿지 않았고, 형태만 남아 있었다. 멀리서 보면 장난감과 다르지 않았다. 그 크기로 미루어보면, 이곳은 충분히 높은 곳이었다.\n\n등 뒤에서 인간의 목소리가 들려왔다. 무슨 말을 하는지는 알 수 없었다. 하지만 표정과 손짓만으로도 충분했다. 불만이었다. 그 방향은 분명히 레오를 향하고 있었다.\n\n무언가가 일어날 것이라는 예감이 스쳤다. 그러나 대비할 시간은 없었다.\n\n인간의 손이 내려왔다. 뒷덜미를 잡히는 순간, 시야가 급격히 낮아졌다. 공간이 접히듯 좁아졌다. 캔넬이었다. 레오는 몸을 비틀었다. 앞발을 뻗고 이를 드러냈다. 하지만 움직임은 끝까지 전달되지 않았다. 허공을 긁는 감각만이 남았다. 물속에서 발버둥칠 때와 비슷했다. 저항은 있었지만, 닿는 것은 없었다.\n\n어릴 적의 감각이 먼저 반응했다. 캔넬 안에서 보냈던 시간. 그때의 냄새와 흔들림이 겹쳐졌다. 이유를 따질 틈은 없었다. 몸은 이미 결론을 알고 있었다.\n\n다시 캔넬 문이 열렸을 때, 장소는 바뀌어 있었다. 흰 벽. 소독약 냄새. 하얀 가운을 입은 인간들이 레오를 내려다보고 있었다. 그들은 서로 말을 주고받았다. 레오가 알아들을 수 없는 소리였다. 그러나 그 대화에 자신이 포함되어 있다는 사실만은 분명했다.\n\n주사가 들어왔다. 몸이 무거워졌다. 이어서 수술이 시작됐다. 동의는 묻지 않았다. 레오의 의사는 필요하지 않았다. 이 과정에서 중요한 것은, 그가 무엇을 원하는지가 아니었다.\n\n레오는 자신의 몸을 내려다보고 있었다. 메스가 닿았고, 피부가 갈라졌다. 찌르는 동작이 반복됐다. 이상하게도 통증은 선명하지 않았다. 감각은 멀어지고, 시야는 위에서 아래를 내려다보는 형태로 고정됐다. 그는 움직이지 않았고, 움직일 수 없었다.\n\n그때 소리가 들렸다.\n\n작았지만 분명했다. 다른 소리들 사이에서 유독 또렷했다. 어디선가 들려온 목소리였다. 익숙했다.\n\n“아빠…”\n\n그 뒤의 말은 이어지지 않았다. 이어졌을지도 모른다. 하지만 레오에게 도달하지는 않았다. 소리는 중간에서 끊겼고, 의미는 남지 않았다. 마치 기억에서 지워진 부분처럼, 빈 자리만 남았다.\n\n눈을 뜨자 태화강이 보였다. 물 위로 빛이 부서지고 있었다. 레오는 한동안 움직이지 않았다. 방금까지의 장면이 사라졌다는 사실을 받아들이는 데 시간이 필요했다. 꿈이었다. 불쾌한 꿈이었다. 과거의 어떤 기억과 맞닿아 있다는 점만은 분명했지만, 형태는 끝내 떠오르지 않았다.\n\n목에 걸린 방울이 느껴졌다. 평소보다 무거웠다. 실제 무게 때문인지, 아니면 다른 이유 때문인지는 알 수 없었다. 고개를 숙이자 방울이 흔들리며 소리를 냈다. 그 소리는, 여전히 자신이 여기 있다는 사실을 증명하고 있었다.\n\n어딘가 비어 있는 감각이 레오에게 남아 있었다. 무엇인가 빠져 있다는 느낌이었다. 하지만 그 대상은 떠오르지 않았다. 떠오르지 않는다는 점에서, 중요하지 않은 일일 가능성이 높다고 그는 판단했다. 기억나지 않는 것은 대개 생존에 큰 영향을 주지 않는다.\n\n레오는 그 공백을 배고픔으로 정리했다. 그러자 계산은 자연스럽게 맞아떨어졌다. 판단이 흐릿해진 이유도, 생각이 같은 자리를 맴도는 이유도 설명이 됐다. 고양이는 배가 비면 정확한 선택을 하지 못한다. 인간을 경계한다고 말하던 고양이들조차, 허기 앞에서는 고개를 숙였다.\n\n며칠째 제대로 된 먹이를 얻지 못하고 있었다. 예전에는 다가가기만 해도 무언가를 내밀던 인간들이, 이제는 시선을 피했다. 레오는 자신의 모습이 달라졌다는 사실을 알고 있었다. 관리에서 벗어난 직후까지는 털이 정돈돼 있었고, 움직임도 느긋했다. 인간들은 그것을 귀엽다고 불렀다. 그 덕분에 한동안은 굶지 않았다.\n\n하지만 상황은 바뀌었다. 더 깨끗하고, 더 어린 고양이들이 그 자리를 차지했다. 인간의 관심은 나뉘지 않는다. 대체될 뿐이다. 레오에게 돌아올 몫은 없었다.\n\n한 번은 쓰레기통을 확인하다가 인간에게 들켰다. 목에 걸린 방울이 소리를 냈다는 사실을 나중에야 떠올렸다. 인간의 발이 날아왔다. 레오는 그 장면을 계산하지 못했다. 대비하지 않았기 때문이다. 인간에게 차이는 장면은 그의 머릿속에 준비되어 있지 않았다. 그래서 그는 그대로 밀려났다. 바닥을 굴렀고, 잠시 숨이 막혔다.\n\n레오는 원래 느린 고양이였다. 보호소에서 태어났고, 태어난 날 어미를 잃었다. 기억은 없었다. 다만 그곳에 자신만 남았다는 결과만이 있었다. 행동도, 결정도 고양이답지 않다는 말을 들었다. 인간에게 쉽게 다가갔고, 손길을 피하지 않았다. 느림은 길 위에서는 단점이었고, 실내에서는 장점이었다.\n\n그의 주인이 레오를 데려간 이유도 그 때문이었다. 선택은 빠르게 이루어졌고, 검토는 필요 없었다. 느긋한 고양이는 관리하기 쉬웠다. 레오는 그 기준에 부합했다.\n\n인간의 집에는 이미 다른 고양이가 있었다. 또래로 보이는 암컷이었다. 어린 나이였지만, 움직임에는 묘한 안정감이 있었다. 레오는 그 점을 먼저 알아차렸다. 인간들이 붙여준 이름은 기억하지 않았다. 중요하지 않았기 때문이다. 그는 그녀를 이름으로 부르지 않았다. 대신, 그 자리에 함께 있다는 사실만을 인식했다.\n\n그것으로 충분했다. 그때의 레오에게는, 그것이 전부였다.\n\n지금의 레오는 혼자였다. 과거의 기억은 길 위에서 하나씩 지워졌다. 언제부터였는지는 중요하지 않았다. 그녀에 대해서도 마찬가지였다. 첫 만남을 떠올릴 수는 없었다. 다만 설명할 수 없는 감정만이 남아 있었다.\n\n레오는 몸을 일으켰다. 가능한 한 빨리 움직이려 했다. 악몽이 스쳐간 자리에 오래 머무르고 싶지 않았다. 이곳을 떠나면, 그 감각도 함께 흐려질 것이라 판단했다.\n\n일어서자마자 배속에서 신호가 올라왔다. 허기였다. 판단보다 먼저 도착한 감각이었다. 지금 필요한 것은 생각이 아니라, 먹을 것이었다.\n\n마침 오늘은 고양이 회의가 열리는 날이었다. 회의는 일주일에 한 번, 수요일에 해가 가장 높이 떠 있을 때 진행된다. 인간이 가장 덜 오가는 시간. 공원 안쪽의 정자 아래에서 진행된다. 회의장 바닥 한가운데에는 고양이의 발로 파낸 듯한 얕은 구덩이가 있었다.\n\n회의가 시작되면, 보스라 불리는 대장 고양이가 음식을 나눠준다. 생선 조각 하나와 과일 조각 하나. 크기는 모두 같다. 그 음식들은 단순한 먹이가 아니라, 투표 수단이었다. 찬성은 과일, 반대는 생선을 구덩이에 넣는 방식이다. 사용하지 않은 음식은 먹어도 문제되지 않는다. 기권을 택하면 두 조각 모두를 먹을 수 있었다.\n\n투표는 일주일에 한 번이다. 그에 맞춰 안건도 하나만 다뤄진다. 결과적으로, 일주일에 한 번은 최소한의 식량이 보장된 셈이었다. 그것이 이 회의가 유지되는 이유였다.\n\n레오는 몸을 움직였다. 오늘 회의에 참여해 기권을 할 생각이었다. 다른 고양이들은 이미 안건을 알고 있을 것이다. 하지만 레오에게는 알려줄 고양이가 없었다. 안건의 내용은 중요하지 않았다. 그에게 중요한 것은 음식의 개수였다.\n\n그는 걸음을 재촉했다. 회의가 시작된 뒤에는 음식이 남지 않는다. 그 사실만으로 충분했다. 오늘도 굶을 가능성이 있다는 계산이, 레오의 발을 앞으로 밀어냈다.`
    }
  ]
};
